...
bool qhHalfEdge::IsConvex( qhReal Tolerance ) const
	{
	qhReal Distance = Face->Plane.Distance( Twin->Face->Centroid );
	return Distance < -Tolerance;	
	}


//--------------------------------------------------------------------------------------------------
bool qhHalfEdge::IsConcave( qhReal Tolerance ) const
	{
	qhReal Distance = Face->Plane.Distance( Twin->Face->Centroid );
	return Distance > Tolerance ;	
	}
...
// qhFace
//--------------------------------------------------------------------------------------------------
bool qhFace::IsTriangle() const
	{
	return qhVertexCount( this ) == 3;
	}
...
void qhNewellPlane( qhFace* Face )
	...
	qhVector3 V0 = Edge->Origin->Position;
	...
	do 
		...
		qhVector3 V1 = Edge->Origin->Position - V0;
		qhVector3 V2 = Twin->Origin->Position - V0;

		Count++;
		Centroid += Edge->Origin->Position;;
