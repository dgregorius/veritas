...
GLAPI void gladDebugOutput( GLenum Source, GLenum Type, GLuint Id, GLenum Severity, GLsizei Length, const GLchar* Message, const void* UserContext );
...
// Local helper
inline void glad_glBindElementBuffer( GLuint buffer )
	{
	glBindBuffer( GL_ELEMENT_ARRAY_BUFFER, buffer );
	}

#define glBindElementBuffer glad_glBindElementBuffer
