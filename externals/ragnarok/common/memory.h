...
char* rkStrStr( char* String, const char* SubString );
const char* rkStrStr( const char* String, const char* SubString );
char* rkStrIStr( char* String, const char* SubString );
const char* rkStrIStr( const char* String, const char* SubString );
int rkToLower( int Character );
int rkToUpper( int Character );

size_t rkAlign( size_t Offset, size_t Alignment );
...
uint32 rkNextPowerOfTwo( uint32 X );
bool rkIsPowerOfTwo( uint32 X );
...
template < typename T > void rkCopyConstruct( int Count, T* Objects, const T& Value );
