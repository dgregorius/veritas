/*
    ...
    OpenGL loader generated by glad 0.1.36 on Wed Feb 22 01:28:47 2023.
    ...
    Commandline:
        --profile="core" --api="gl=4.6" --generator="c" --spec="gl" --local-files --extensions="GL_ARB_bindless_texture,GL_ARB_gpu_shader_int64"
    Online:
...
// Extension
void gladDebugOutput( GLenum Source, GLenum Type, GLuint Id, GLenum Severity, GLsizei Length, const GLchar* Message, const void* UserContext )
	{
	...
	switch ( Type )
		...
		case GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR: printf( "Type: Deprecated Behavior" ); break;
		case GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR:  printf( "Type: Undefined Behavior" ); break;
